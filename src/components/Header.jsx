      ...
      <header>
        ...
        <div className="first-nav" id="up">
          ...
          <div className="nav-social-part">
            ...
            <a href="https://github.com/fromNIKO">
          ...
          <nav className="hamburger-menu">
            ...
            <div className="nav-flex">
              ...
              <ul className="ul-flex">
                ...
                <li>
                  <a href="#project">Mes réalisations</a>
                </li>
        ...
        <div className="text-header">
          ...
          <div className="content">
            <LetterAnimation
              className="content"
              text="Développeur web en alternance"
            />
          </div>
        </div>
        ...
        <div ref={arrowAppear}>
          <a href="#up" className="up" id="upAnim">
